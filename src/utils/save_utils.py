...
def truncate_training_file(in_fn, out_fn, trunc_epoch):
    ...
    schedule_params = {'learning_schedule': ['lr', 'lambda_regr', 'lambda_corr'],
...
if __name__ == "__main__":
    ...
    truncate_training_file('output/sb_hierarchical_MSElog1em1_MSE_doubling_negatives/training/sb_hierarchical_MSElog1em1_MSE_doubling_negatives_metrics.pt',
                           ...
                           14)
    #compare_model_files('output/bb_hierarchical/training/bb_hierarchical_model_epoch_9.pt', 'output/bb_hierarchical/training/bb_hierarchical_model_epoch_14.pt')